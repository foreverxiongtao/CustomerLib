package com.desperado.customerlib.view.flycotablayout;
...
import com.desperado.customerlib.view.flycotablayout.listener.OnTabSelectListener;
import com.desperado.customerlib.view.flycotablayout.utils.UnreadMsgUtils;
import com.desperado.customerlib.view.flycotablayout.widget.MsgView;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private boolean mTextWidthFull=true;
    ...
    /**
     * 设置tab宽度是否随文字改变
     * @param mTextWidthFull true 撑满  false不撑满
     */
    public void setmTextWidthFull(boolean mTextWidthFull) {
        this.mTextWidthFull = mTextWidthFull;
    }
    ...
    private void addTab(final int position, String title, View tabView) {
        ...
        if(!mTextWidthFull){
            ...
            LinearLayout.LayoutParams lp_tab  = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT,1.0f);
            lp_tab.leftMargin=20;
            lp_tab.rightMargin=20;
            mTabsContainer.addView(tabView, position, lp_tab);
        }
    }
